...
const LandingPageFalseArkaYuzBarkod = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.landingPageFalseArkayuz}>
      <Image
      ...
      />
      <Text style={[styles.talimatSayfasnaDnmek, styles.kimliinArkaYznnTypo]}>
      ...
      />
      <Text style={[styles.kimliinArkaYznn, styles.kimliinArkaYznnTypo]}>
        Kimliğin arka yüzünün taranması tamamlandı ancak barkod uyuşmamaktadır. Lütfen verilen
        talimatlara dikkat ederek kimlik fotoğrafını tekrar çekiniz.
      </Text>
    </View>
  );
};
...
export default LandingPageFalseArkaYuzBarkod;
