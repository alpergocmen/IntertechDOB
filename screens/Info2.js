...
const Info2 = () => {
  ...
  return (
    <View style={styles.info2}>
      ...
      />
      <Text style={styles.kimliinArkaYzn}>
        Kimliğin arka yüzünü düz bir zemin üzerinde, kenarları dikdörtgene denk
        gelecek şekilde ve yazıları okunaklı olacak şekilde tutun.
      </Text>
